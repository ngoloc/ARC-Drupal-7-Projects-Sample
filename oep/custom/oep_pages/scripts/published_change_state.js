function change_state(nid)
{
	$("#change_state_dialog").html( '<div class="form-item form-type-radio" style="font-size : 110%;">'
								   ...
								   +'	<input type="radio" class="form-radio" value="needs_eic_review" name="moderation_state" id="needs_eic_review"><label for="needs_eic_review" class="option" style="color:red">Needs EIC review</label><br>'
								   +'	<input type="radio" class="form-radio" value="needs_me_review" name="moderation_state" id="needs_me_review"><label for="needs_me_review" class="option" style="color:red">Needs ME review</label><br>'
								   +'	<input type="radio" class="form-radio" value="needs_ce_review" name="moderation_state" id="needs_ce_review"><label for="needs_ce_review" class="option" style="color:red">Needs CE review</label><br>'
								   +'</div>');
